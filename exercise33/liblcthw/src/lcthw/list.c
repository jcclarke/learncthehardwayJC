...
// add(push) new node to end of list. 
...
// remove(shift) node from the end of the list
...
// add(unshift) new node to the beginning of list
...
// remove(shift) node from the beginning of the list
...
// remove node from list, free node and return value
